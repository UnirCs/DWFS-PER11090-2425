...
let pathToImage = path.join(__dirname, "input", "tucan.jpg");
let handler = new ImageHandler(pathToImage);
 ...
 */
function ejemplo() {
  let outputPath = path.join(__dirname, "output", "ejemplo1.jpg");
  let pixeles = [];
  let filas = 2;
  let columnas = 2;
...
function redConverter() {
  let outputPath = path.join(__dirname, "output", "tucan_red.jpg");
...
function greenConverter() {
  let outputPath = path.join(__dirname, "output", "tucan_green.jpg");
  let pixels = handler.getPixels();
  for (let row of pixels) {
    for (let pixel of row) {
      pixel[0] = 0;
...
function blueConverter() {
  let outputPath = path.join(__dirname, "output", "tucan_blue.jpg");
  let pixels = handler.getPixels();
...
function greyConverter() {;
  let outputPath = path.join(__dirname, "output", "tucan_grey.jpg");
...
function blackAndWhiteConverter() {
  let outputPath = path.join(__dirname, "output", "tucan_black_and_white.jpg");
  let pixels = handler.getPixels();
 ...
 */
function scaleDown() {    
    let outputPath = path.join(__dirname, "output", "tucan_scale_down.jpg");
    let pixels = handler.getPixels();
    let newPixels = [];
...
function dimBrightness(dimFactor) {
  let outputPath = path.join(__dirname, "output", "tucan_dimed.jpg");
  let pixels = handler.getPixels();
...
function invertColors() {
  let outputPath = path.join(__dirname, "output", "tucan_inverse.jpg");
  let pixels = handler.getPixels();
...
function merge(alphaFirst, alphaSecond) {  
  let pathToImage = path.join(__dirname, "input", "cat.jpg");
  let catHandler = new ImageHandler(pathToImage);
  pathToImage = path.join(__dirname, "input", "dog.jpg");
  let dogHandler = new ImageHandler(pathToImage);
  let outputPath = path.join(__dirname, "output", "merged.jpg");
