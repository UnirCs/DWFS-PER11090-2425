...
function redConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      // Mantener el canal R, pero poner G y B a 0
...
function greenConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      // Mantener el canal G, pero poner R y B a 0
...
function blueConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      // Mantener el canal B, pero poner R y G a 0
...
function greyConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      ...
      // Asignar el promedio a cada canal
...
function blackAndWhiteConverter() {
  ...
  for (let i = 0; i < pixels.length; i++) {
    for (let j = 0; j < pixels[i].length; j++) {
      let avg = Math.floor((pixels[i][j][0] + pixels[i][j][1] + pixels[i][j][2]) / 3);
      // Si el promedio es menor que 128, ponerlo a negro, si no a blanco
